...
import { PricingPlan, Product } from "../../data/types";
...
export type PricingCardProps = {
   ...
   * The action variant
   */
  actionVariant?: ComponentPropsWithoutRef<typeof Button>["variant"];
  /**
...
export function pricingPlanToPricingCardProps(
  ...
  return {
    ...
    actionVariant: index === 1 ? "outline" : "default",
  ...
  return (
    ...
    >
      ...
      <Flex alignPrimary="stretch">
        <Button className="flex-1" disabled variant="default">
          &nbsp;
        </Button>
      </Flex>
    </Card>
